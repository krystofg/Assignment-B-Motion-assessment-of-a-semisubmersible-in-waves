...
\[
    ...
    = 3088.855~\mathrm{m^3}.
\]
The two pontoons are approximated as rectangular boxes with cross-section
\((2b)\times(2b)\), so that
\[
    V_{\mathrm{pontoons}}
    = 2 L (2b)(2b)
    = 16866.144~\mathrm{m^3}.
\]
Hence, the total displaced volume is
\[
    \nabla
    = V_{\mathrm{columns}} + V_{\mathrm{pontoons}}
    = 19954.999~\mathrm{m^3}.
\]
The platform mass becomes
\[
    M = \rho \nabla
    = 2.0454 \times 10^7~\mathrm{kg}
    = 20453.874~\mathrm{tons}.
\]
...
\[
    A_{33,p}
    = 2 C_{m,p} \rho A_{R,p} L
    = 2.0502 \times 10^7~\mathrm{kg}
    = 20502.485~\mathrm{tons}.
\]

The total added mass in heave is
\[
    A_{33} = A_{33,c} + A_{33,p}
    = 2.3669 \times 10^7~\mathrm{kg}
    = 23668.561~\mathrm{tons}.
\]
Finally, the effective mass in heave is
\[
    M_{\mathrm{eff}} = M + A_{33}
    = 4.4122 \times 10^7~\mathrm{kg}
    = 44122.435~\mathrm{tons}.
\]
